		...
		<footer class="ampstart-footer flex flex-column items-center mx-auto max-width-3 ">
			...
			<nav class="ampstart-footer-nav">
				<ul class="list-reset flex flex-wrap mb3">
					<li class="px1"><a class="text-decoration-none ampstart-label" href="#">Home</a></li>
					<li class="px1"><a class="text-decoration-none ampstart-label" href="#">Chi siamo</a></li>
                    <li class="px1"><a class="text-decoration-none ampstart-label" href="#">Blog</a></li>
					<li class="px1"><a class="text-decoration-none ampstart-label" href="#">Contatti</a></li>
				</ul>
			</nav>
			<small>
			© Laravel Xot • 
